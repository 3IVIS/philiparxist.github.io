...
[API Docs](https://docs.codat.io/lending-api#/operations/get-categorized-bank-statement)

### [finAPI](https://www.finapi.io/en/products/data-intelligence/categorization/)
[API Docs](https://docs.finapi.io/#post-/cases/-caseId-/report/recurring)

### [Plaid](https://plaid.com/products/enrich/)
[API Docs](https://plaid.com/docs/api/products/transactions/#transactionsget)

### [Tink](https://tink.com/products/data-enrichment/)
[API Docs](https://docs.tink.com/api-enrichment#enrichment)

### [Truelayer](https://docs.truelayer.com/docs/transaction-data-reference)
[API Docs](https://docs.truelayer.com/reference/getaccounttransactions)
